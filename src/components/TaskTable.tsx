                ...
                <TableRow key={t.id} hover onClick={() => setDetails(t)} sx={{ cursor: 'pointer' }}>
                  <TableCell>
                    <Stack spacing={0.5}>
                      ...
                      {t.notes && (
                        // FIXED: Removed "dangerouslySetInnerHTML" to prevent XSS attacks
                        <Typography
                          variant="caption"
                  ...
                  <TableCell align="right">
                    <Stack direction="row" spacing={1} justifyContent="flex-end">
                      <Tooltip title="Edit">
                        {/* FIXED BUG 4: Added e.stopPropagation() to prevent opening details dialog */}
                        <IconButton 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleEditClick(t);
                      ...
                      <Tooltip title="Delete">
                        {/* FIXED BUG 4: Added e.stopPropagation() here too */}
                        <IconButton 
                          onClick={(e) => {
                            e.stopPropagation();
                            onDelete(t.id);
